...
import com.yonyou.ny.yht.yhttest.filter.YHTLoginFilter;
...
public class YHTCASAutoConfiguration {
    ...
    public FilterRegistrationBean casSingleSignOutFilter() {
        ...
        singleSignOutFilter.addInitParameter("handlerClass", YHTSingleSignOutHandler.class.getName());
    ...
    public FilterRegistrationBean casProxyReceivingTicketValidationFilter() {
        ...
        proxyReceivingTicketValidationFilterFilter.setFilter(new YHTLoginFilter());
